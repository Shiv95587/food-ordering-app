...
public class TinyDB {
    ...
    public ArrayList<User> getListUser(String key){
        ...
        for(String jObjString : objStrings){
            User player  = gson.fromJson(jObjString,  User.class);
            playerList.add(player);
        }
        return playerList;
    }
    ...
    public ArrayList<Transaction> getListTransaction(String key){
        ...
        ArrayList<String> objStrings = getListString(key);
        ArrayList<Transaction> playerList =  new ArrayList<Transaction>();
        for(String jObjString : objStrings){
            Transaction player  = gson.fromJson(jObjString,  Transaction.class);
            playerList.add(player);
        }
        return playerList;
    }
    ...
    public void putListTransaction(String key, ArrayList<Transaction> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Transaction player: playerList){
            objStrings.add(gson.toJson(player));
        }
        putListString(key, objStrings);
    }
